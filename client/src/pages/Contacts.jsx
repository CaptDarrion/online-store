  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <p className="text-lg text-gray-700 mb-6">
        Дякуємо за інтерес до магазину{" "}
        <span className="font-semibold text-green-600">Nature`s Prophet</span>!
        Ми завжди раді відповісти на ваші запитання та допомогти з будь-якими
        проблемами. Якщо у вас виникли запитання або потрібна допомога — не
      ...
      <p className="text-lg text-gray-700 mb-2">
        <strong>Адреса:</strong> Приморська, 12, Одеса, Україна
      </p>
      <p className="text-lg text-gray-700 mb-2">
        <strong>Телефон:</strong> +380 (66) 134-80-11
      </p>
      <p className="text-lg text-gray-700 mb-2">
